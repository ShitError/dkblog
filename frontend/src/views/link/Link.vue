  ...
  <div>
    ...
    <v-card class="blog-container">
      <div class="link-title mb-1">
        <v-icon color="#ef632b">mdi-link-variant</v-icon> 大佬链接
      </div>
      ...
      <div class="link-title mt-4 mb-4">
        <v-icon color="#ef632b">mdi-dots-horizontal-circle</v-icon> 添加友链
      </div>
      <blockquote>
...
blockquote {
  ...
  margin: 0;
  font-size: 15px;
  border-left: 0.2rem solid #ba2f7b;
