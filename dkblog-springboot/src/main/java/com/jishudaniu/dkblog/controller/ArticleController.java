...
import com.jishudaniu.dkblog.enums.FilePathEnum;
import com.jishudaniu.dkblog.pojo.entity.Article;
import com.jishudaniu.dkblog.service.ArticleService;
import com.jishudaniu.dkblog.strategy.context.UploadStrategyContext;
...
import static com.jishudaniu.dkblog.constant.OptTypeConst.*;
import static com.jishudaniu.dkblog.constant.RedisPrefixConst.ARTICLE_VIEWS_COUNT;
...
public class ArticleController {
     ...
     * 获取最新文章
     *
     * @return {@link Result<List<ArticleRecommendDTO>>}
     */
    @ApiOperation(value = "获取最新文章")
    @GetMapping("/newest/articlelist")
    public Result<List<ArticleRecommendDTO>> listArticlesnewest() {
        return Result.ok(articleService.listArticlesnews());
    }

    /**
     * 获取最热文章
     *
     * @return {@link Result<List<ArticleRankDTO>>}
     */
    @ApiOperation(value = "获取最热文章")
    @GetMapping("/hottest/articlelist")
    public Result<List<ArticleRankDTO>> listArticleshottest() {
        return Result.ok(articleService.listArticleshots());
    }
